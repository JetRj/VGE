...
export * from "./common";
import {
  angularNodeTemplateHtml,
  angularTreeTemplateHtml,
} from "./angular-variables";
...
export class NodeComponent<T> {
  ...
  @Output() toggle = new EventEmitter<common.EventData<T>>();
  @Output() change = new EventEmitter<common.EventData<T>>();
  ...
  get hasMarker() {
    return (
      this.draggable &&
      this.data.state.dropPosition !== common.DropPosition.empty
    );
  }
...
export class TreeComponent<T> {
  ...
  @Input() checkbox?: boolean;
  @Input() draggable?: boolean;
  @Input() nodots?: boolean;
  @Input() size?: string;
  @Input() theme?: string;
  @Input() dropAllowed?: (dropData: common.DropData<T>) => boolean;
  @Input() preid?: string;

  @Output() toggle = new EventEmitter<common.EventData<T>>();
  @Output() change = new EventEmitter<common.EventData<T>>();
  @Output() drop = new EventEmitter<common.DropData<T>>();
